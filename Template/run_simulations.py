...
#        if each_study == 'your study name'
#           do what you have to do for the schedules of your other study if necessary
...
for each_study in study:
    for each_model in models:
        ...
        # copy the baseline template and paste (NOTE: if you have another study... be sure to have a /run_all_models_OTHERSTUDY.osw file!! )
