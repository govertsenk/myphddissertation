...
if not os.path.exists(puma_path + 'Weather/AMY/'):
    os.makedirs(puma_path + 'Weather/AMY/')    
...
for each_year in np.arange(2001,2023,1):
    ...
    while not os.path.exists(download_folder + '/'+ new_weather_name):
        time.sleep(1)
    os.rename(download_folder + '/' + new_weather_name, download_folder + '/' + puma + '_' + str(each_year) + '.epw')
